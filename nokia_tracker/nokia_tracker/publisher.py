...
_ENTITIES: list[_Entity] = [
    ...
    _Entity("sensor", "forecast_1w_eur", "Forecast 1W", "EUR", None, "measurement",
           "mdi:crystal-ball", has_attrs=True),
    _Entity("sensor", "forecast_1m_eur", "Forecast 1M", "EUR", None, "measurement",
           "mdi:crystal-ball", has_attrs=True),
    _Entity("sensor", "forecast_12m_eur", "Forecast 12M", "EUR", None, "measurement",
           "mdi:crystal-ball", has_attrs=True),
